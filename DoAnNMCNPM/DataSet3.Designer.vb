...
Partial Public Class DataSet3
    ...
    Partial Public Class SachDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddSachRow(ByVal MaSach As String, ByVal TenSach As String, ByVal TheLoai As String, ByVal TacGia As String, ByVal SoLuongTon As Integer, ByVal DonGia As Double) As SachRow
            Dim rowSachRow As SachRow = CType(Me.NewRow,SachRow)
            Dim columnValuesArray() As Object = New Object() {MaSach, TenSach, TheLoai, TacGia, SoLuongTon, DonGia}
    ...
    Partial Public Class SachRow
        ...
        Public Function IsMaSachNull() As Boolean
            Return Me.IsNull(Me.tableSach.MaSachColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Sub SetMaSachNull()
            Me(Me.tableSach.MaSachColumn) = Global.System.Convert.DBNull
        End Sub
