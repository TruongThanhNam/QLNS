...
Public Class KhachHangDAL
  ...
  Public Function LayDuLieuInAn() As DataSet
    DataAccess.Openconnection()
    Dim adapter As OleDbDataAdapter = New OleDbDataAdapter("select * from KhachHang", DataAccess.connection)
  ...
  Public Function LayID() As String
    ...
    While reader.Read()
      khachhang.MaKhachHang = reader.GetString(0)
      If khachhang.MaKhachHang <> "" Then
        Dim chisoo As String = khachhang.MaKhachHang.Substring(3)
