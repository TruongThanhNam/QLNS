Public Class ThamSo
  ...
  Private _SuDungQuyDinhSoTienThuVuotSoTienNo As Boolean
  ...
  Public Property SuDungQuyDinhSoTienNoToiDa() As Boolean
    ...
    End Set
  End Property
  Public Property SuDungQuyDinhSoTienThuVuotSoTienNo() As Boolean
    Get
      Return _SuDungQuyDinhSoTienThuVuotSoTienNo
    End Get
    Set(value As Boolean)
      _SuDungQuyDinhSoTienThuVuotSoTienNo = value
    End Set
  End Property
  ...
  Public Sub New()
    ...
    _SuDungQuyDinhSoTienThuVuotSoTienNo = False
  End Sub

  Public Sub New(ByVal soluongnhapitnhat As Integer, ByVal soluongtontoidatruocnhap As Integer, ByVal soluongtonsautoithieu As Integer, ByVal sotiennotoida As Double, ByVal sudungquydinhsotiennotoida As Boolean, ByVal sudungquydinhsotienthuvuotsotienno As Boolean)
    ...
    _SuDungQuyDinhSoTienThuVuotSoTienNo = sudungquydinhsotienthuvuotsotienno
  End Sub
End Class
