...
Public Class ThamSoDAL
  Public Function LayDuLieu() As ThamSo
    ...
    While reader.Read
      ...
      thamso.SuDungQuyDinhSoTienThuVuotSoTienNo = reader.GetBoolean(6)
    End While
    reader.Close()
    Return thamso
  End Function
  Public Function CapNhatDuLieu(ByVal soluongnhapitnhat As Integer, ByVal soluongtontoidatruocnhap As Integer, ByVal soluongtonsautoithieu As Integer, ByVal sotiennotoida As Double, ByVal sudungquydinhsotiennotoida As Boolean, ByVal sudungquydinhsotienthuvuotsotienno As Boolean) As Boolean
    DataAccess.Openconnection()
    Dim command As OleDbCommand = New OleDbCommand()
    command.CommandType = CommandType.Text
    command.CommandText = "update ThamSo set SoLuongNhapItNhat=@soluongnhapitnhat,SoLuongTonToiDaTruocNhap=@soluongtontoidatruocnhap,SoLuongTonSauToiThieu=@soluongtonsautoithieu,SoTienNoToiDa=@sotiennotoida,SuDungQuyDinhSoTienNoToiDa=@sudungquydinhsotiennotoida,SuDungQuyDinhSoTienThuVuotSoTienNo=@sudungquydinhsotienthuvuotsotienno"
    command.Connection = DataAccess.connection
    ...
    command.Parameters.Add("@sudungquydinhsotienthuvuotsotienno", OleDbType.Boolean).Value = sudungquydinhsotienthuvuotsotienno
